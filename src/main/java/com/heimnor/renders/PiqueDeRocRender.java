...
public class PiqueDeRocRender implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED: {
			...
			GL11.glTranslatef(0.55F, 0.2F, 0.1F);

			GL11.glRotatef(10.0F, 1.0F, 1.0F, 1.0F);
			GL11.glRotatef(420.0F, 0.5F, 0.0F, 1.0F);
			GL11.glRotatef(210.0F, 0.2F, 1.0F, 0.05F);
		...
		case EQUIPPED_FIRST_PERSON: {
			...
			GL11.glTranslatef(0.8F, 0.3F, 0.15F);

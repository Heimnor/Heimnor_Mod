...
public class ArmesPoingRender implements IItemRenderer {
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		...
		case EQUIPPED: {
			...
			GL11.glPushMatrix();
			GL11.glScalef(0.78F, 0.85F, 0.88F);
			GL11.glTranslatef(0.60F, 0.35F, -0.3F);

			GL11.glRotatef(20.0F, 5.0F, 0.35F, 0.5F);
			GL11.glRotatef(38.0F, -8.0F, 0.6F, -3.2F);
			GL11.glRotatef(55.0F, -0.1F, 1.3F, -1.0F);
		...
		case EQUIPPED_FIRST_PERSON: {
			...
			GL11.glTranslatef(0.60F, 0.33F, -0.3F);

			GL11.glRotatef(20.0F, 4.0F, 0.35F, 0.5F);
			GL11.glRotatef(35.0F, -8.0F, 0.6F, -3.2F);
			GL11.glRotatef(55.0F, -0.1F, 1.3F, -1.0F);
			this.renderItem(living, item, renderPass);
			GL11.glPopMatrix();
			break;
